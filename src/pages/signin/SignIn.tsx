...
import { Checkbox } from '../../components/checkbok/Checkbox';
...
export const SignIn: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center gap-10 text-gray-100">
